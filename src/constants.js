...
export const MS_PER_DAY = 86_400_000; // milissegundos em um dia (24h) — converte dias <-> ms em diasEntre() e paraData()
export const EXCEL_EPOCH_OFFSET = 25569; // dias entre 1900-01-01 (época do Excel) e 1970-01-01 (época Unix) — usado em paraData() pra converter serial do Excel em Date
